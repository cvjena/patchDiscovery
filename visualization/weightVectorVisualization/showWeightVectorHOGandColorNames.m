function out = showWeightVectorHOGandColorNames( w, settings )
% function out = showWeightVectorHOGandColorNames( w, settings )
% 
...
% 
% BRIEF :
%   Given a weight vector w obtained by training a model with colorNames, 
...
%    out     -- (optional), the resulting image of visualized model
    ...
    imPos = visualizeHOGandColorNames (  w, settings );
    imNeg = visualizeHOGandColorNames ( -w, settings );
